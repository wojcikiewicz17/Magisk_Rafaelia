#!/bin/bash
# sccache.sh - Install sccache for GitHub Actions CI This script installs Mozilla's sccache (Shared Compilation Cache) which speeds up Rust compilation by caching compilation results. This is particularly useful in CI
#
...
# 
# ⚓ ANCHOR_ID: 3D659F14EFC3D89A
# ⚓ FILE_PATH: .github/actions/setup/sccache.sh
...
# ⚓ INTEGRITY_HASH: E4BBECD0D0DEA56695CDDC52B6C2F76F
